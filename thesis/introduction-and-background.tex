...
Traditionally,
the Thomas algorithm is employed for solving tridiagonal systems.
...
Only the non-zero diagonals of the tridiagonal system
are stored,
...
cyclic reduction (CR) and parallel cyclic reduction (PCR)
algorithms.
