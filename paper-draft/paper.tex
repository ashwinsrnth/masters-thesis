...
Our implementation uses the NVIDIA CUDA platform,
...
spanning no more than 100 lines.
...
All timings reported are for the tridiagonal solution
and are averaged over several (100) solves.
...
On a single GPU,
this is done easily using the NEATO solver.
...
\begin{table}[]
\centering
\caption{Purpose of kernels and MPI calls}
...
as they are assembled from the boundary elements of $\bm{x_r}$,
...
Talk about which GPUs, cluster information

Figures \ref{fig:strong-scaling-256}-\ref{weak-scaling-256}
