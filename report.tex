...
\section{Parallelization strategies}
    ...
    \begin{minipage}[b]{0.40\linewidth}
    \begin{center}
    \includegraphics[trim={{50pt} {150pt} {100pt} {150pt}}, clip, height=200pt]{img/one-thread.eps}
    \end{center}
    ...
    \textbf{Thread-level parallelism} \\
        ...
        \begin{figure}[h]
        \begin{center}
        \includegraphics[trim={{100pt} {150pt} {100pt} {150pt}}, clip, height=300pt]{img/thread-parallel.eps}
        \end{center}
        \caption{Parallel x}
    ...
    \textbf{Data parallelism} \\
        ...
        \begin{figure}[h]
        \begin{center}
        \includegraphics[trim={{100pt} {150pt} {100pt} {150pt}}, clip, height=300pt]{img/data-parallel.eps}
        \end{center}
        \caption{Parallel yz}
...
\begin{figure}[h]
\begin{center}
\includegraphics[trim={{100pt} {150pt} {100pt} {150pt}}, clip, height=300pt]{img/data-and-thread-parallel.eps}
\end{center}
